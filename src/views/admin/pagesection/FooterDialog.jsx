...
const FooterDialog = ({ open, onOpenChange, pageId, footerData, id }) => {
  const dispatch = useDispatch()
  const initialItems = footerData || [
    { title: 'Tên công ty', value: '', key: '', url: '' },
    { title: 'Địa chỉ', value: '', key: '', url: '' },
    { title: 'Số điện thoại', value: '', key: '', url: '' },
    { title: 'Giờ hoạt động', value: '', key: '', url: '' },
    { title: 'Email', value: '', key: '', url: '' },
    { title: 'Facebook', value: '', key: '', url: '' },
    { title: 'Zalo', value: '', key: '', url: '' },
    { title: 'Tiktok', value: '', key: '', url: '' },
    { title: 'Youtube', value: '', key: '', url: '' },
  ]
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="md:h-auto md:max-w-6xl">
        <DialogHeader>
          <DialogTitle>
            {footerData ? 'Chỉnh sửa Footer' : 'Thêm Footer'}
          </DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form
