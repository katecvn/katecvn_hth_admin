...
const BulkInvoiceFromSelectionDialog = ({
  open,
  onOpenChange,
  orders = [],
  onCreated,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] overflow-hidden sm:max-w-3xl">
        <DialogHeader className="sticky top-0 bg-background">
          <DialogTitle>Tạo hóa đơn hàng loạt từ đơn đã chọn</DialogTitle>
        </DialogHeader>
                  ...
                  <tbody>
                    ...
                    {orders.map((o) => (
                      <tr key={o.id} className="border-b">
                        <td className="px-2 py-2">{o.code || `HD${o.id}`}</td>
...
export default BulkInvoiceFromSelectionDialog
